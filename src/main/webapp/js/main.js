...
function displayMessage(message) {
	$(document.body).append('<div class="alert alert-info alert-dismissable fade in" style="z-index:5; position:absolute; top:100px; left:' + (30 + $("div#searchDiv").width()) + 'px; min-width:450px;"><a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a><div id="msg">' + message + '</div></div>');
