(function (factory) {
  ...
  (function (global, factory) {
    (typeof exports === "undefined" ? "undefined" : _typeof(exports)) === 'object' && typeof module !== 'undefined' ? module.exports = factory() : typeof define === 'function' && define.amd ? define(factory) : (global = global || self, global.GenotypeRenderer = factory());
  })(undefined, function () {
    ...
    function forEach(obj, fn) {
      var _ref5 = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : {},
        _ref5$allOwnKeys = _ref5.allOwnKeys,
        allOwnKeys = _ref5$allOwnKeys === void 0 ? false : _ref5$allOwnKeys;
    ...
    var ScrollBarWidget = /*#__PURE__*/function () {
      function ScrollBarWidget(x, y, width, height) {
        _classCallCheck$1(this, ScrollBarWidget);
        this.widgetX = x;
        this.widgetY = y;
        this.width = width;
        this.height = height;
      ...
      _createClass$1(ScrollBarWidget, [{
        key: "render",
    ...
    var GenotypeCanvas = /*#__PURE__*/function () {
      function GenotypeCanvas(width, height, boxSize) {
        _classCallCheck$1(this, GenotypeCanvas);
        this.width = width;
        this.height = height;
    ...
    var OverviewCanvas = /*#__PURE__*/function () {
      function OverviewCanvas(width, height) {
        _classCallCheck$1(this, OverviewCanvas);
        this.width = width;
        this.height = height;
        this.canvas = document.createElement('canvas');
        this.canvas.width = width;
    ...
    var AlphabeticLineSort = /*#__PURE__*/function () {
      function AlphabeticLineSort() {
        _classCallCheck$1(this, AlphabeticLineSort);
        this.hasScore = false;
      }
      _createClass$1(AlphabeticLineSort, [{
        key: "sort",
    ...
    var SimilarityLineSort = /*#__PURE__*/function () {
      function SimilarityLineSort(referenceName, chromosomeIndices) {
        _classCallCheck$1(this, SimilarityLineSort);
        this.referenceName = referenceName;
        this.chromosomeIndices = chromosomeIndices;
        this.scoreMap = undefined;
        this.hasScore = true;
      }
      _createClass$1(SimilarityLineSort, [{
        key: "sort",
        value: function sort(dataSet) {
          var _this = this;
    ...
    var ImportingOrderLineSort = /*#__PURE__*/function () {
      function ImportingOrderLineSort() {
        _classCallCheck$1(this, ImportingOrderLineSort);
        this.hasScore = false;
      }
      _createClass$1(ImportingOrderLineSort, [{
        key: "sort",
        value: function sort(dataSet) {
          dataSet.germplasmListFiltered.sort(function (a, b) {
    ...
    var TraitLineSort = /*#__PURE__*/function () {
      function TraitLineSort(traitName) {
        _classCallCheck$1(this, TraitLineSort);
        this.hasScore = false;
        this.traitName = traitName;
      }
      _createClass$1(TraitLineSort, [{
        key: "sort",
        value: function sort(dataSet) {
          var self = this;
    ...
    var NucleotideColorScheme = /*#__PURE__*/function () {
      function NucleotideColorScheme(dataSet) {
        _classCallCheck$1(this, NucleotideColorScheme);
        this.dataSet = dataSet;
      ...
      _createClass$1(NucleotideColorScheme, [{
        key: "getColor",
    ...
    var SimilarityColorScheme = /*#__PURE__*/function () {
      function SimilarityColorScheme(dataSet, compIndex) {
        _classCallCheck$1(this, SimilarityColorScheme);
        this.dataSet = dataSet;
        this.stateTable = this.dataSet.stateTable;
      ...
      _createClass$1(SimilarityColorScheme, [{
        key: "getColor",
    ...
    var CanvasController = /*#__PURE__*/function () {
      function CanvasController(container, genotypeCanvas, overviewCanvas, saveSettings, genotypeAutoWidth, overviewAutoWidth, minGenotypeAutoWidth, minOverviewAutoWidth) {
        _classCallCheck$1(this, CanvasController);
      ...
      _createClass$1(CanvasController, [{
        key: "init",
        ...
        value: function setFilter(input) {
          ...
          this.dataSet.germplasmListFiltered = this.dataSet.germplasmListFiltered.filter(function (item) {
            return item.name.toLowerCase().startsWith(input);
          });
        ...
        value: function loadDefaultSettings() {
          ...
          displayTraits = displayTraits == null ? this.dataSet.traitNames : displayTraits.split(";").filter(function (x) {
            return _this6.dataSet.traitNames == null || _this6.dataSet.traitNames.includes(x);
          });
          var settings = {
    ...
    var Marker = /*#__PURE__*/_createClass$1(function Marker(name, chromosome, position) {
    ...
    var Chromosome = /*#__PURE__*/function () {
      function Chromosome(name, end, markers) {
        _classCallCheck$1(this, Chromosome);
        this.start = 0;
        this.name = name;
        this.end = end;
    ...
    var GenomeMap = /*#__PURE__*/function () {
      function GenomeMap(chromosomes) {
        _classCallCheck$1(this, GenomeMap);
    ...
    var MapImporter = /*#__PURE__*/function () {
      function MapImporter() {
        _classCallCheck$1(this, MapImporter);
        this.markerNames = [];
        this.markerData = [];
        this.chromosomeNames = new Set();
      }
      _createClass$1(MapImporter, [{
    ...
    var Genotype = /*#__PURE__*/function () {
      function Genotype(allele1, allele2, isHomozygous) {
        _classCallCheck$1(this, Genotype);
        this.allele1 = allele1;
        this.allele2 = allele2;
        this.isHomozygous = isHomozygous;
      }
      _createClass$1(Genotype, [{
        key: "getText",
    ...
    var Germplasm = /*#__PURE__*/function () {
      function Germplasm(name, genotypeData, phenotype) {
        _classCallCheck$1(this, Germplasm);
        this.name = name;
        this.genotypeData = genotypeData;
        this.phenotype = phenotype;
      }
      _createClass$1(Germplasm, [{
        key: "getPhenotype",
    ...
    var GenotypeImporter = /*#__PURE__*/function () {
      function GenotypeImporter(genomeMap) {
        _classCallCheck$1(this, GenotypeImporter);
      ...
      _createClass$1(GenotypeImporter, [{
        key: "getState",
    ...
    var PhenotypeImporter = /*#__PURE__*/function () {
      function PhenotypeImporter() {
        _classCallCheck$1(this, PhenotypeImporter);
        this.traitNames = [];
        this.experiments = [];
        this.values = [];
        this.traits = new Map();
      ...
      _createClass$1(PhenotypeImporter, [{
        key: "loadData",
    ...
    var DataSet = /*#__PURE__*/function () {
      function DataSet(dataSetId, genomeMap, germplasmList, stateTable, traits, phenotypes) {
        _classCallCheck$1(this, DataSet);
        this.id = dataSetId;
        this.genomeMap = genomeMap;
    ...
    function GenotypeRenderer() {
      ...
      function populateTraitSelect() {
        ...
        dataSet.traitNames.forEach(function (name) {
          ...
          clone.selected = dataSet.traitNames.length < 10;
