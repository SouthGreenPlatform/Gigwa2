            ...
            <div class="collapse navbar-collapse">
                ...
                <form class="navbar-form navbar-left" role="search" id="moduleProjectNavbar">
                    ...
                    <div class="form-group" id="grpProj">&nbsp;
	                    ...
	                    <a href="#" onclick="displayProjectInfo();" id="projectInfoLink" style="display:none;"><span role='button' title="Click for project information" class="glyphicon glyphicon-info-sign" id="formatHelp" style="color:yellow;"></span></a>
                    </div>
