...
RUN echo -e "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n<beans xmlns=\"http://www.springframework.org/schema/beans\" xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xmlns:mongo=\"http://www.springframework.org/schema/data/mongo\" xsi:schemaLocation=\"http://www.springframework.org/schema/data/mongo http://www.springframework.org/schema/data/mongo/spring-mongo-1.10.xsd http://www.springframework.org/schema/beans http://www.springframework.org/schema/beans/spring-beans-4.3.xsd\">\n<mongo:mongo-client host=\"#{systemEnvironment['MONGO_IP']}\" port=\"#{systemEnvironment['MONGO_PORT']}\" id=\"defaultMongoHost\">\n<mongo:client-options write-concern=\"NORMAL\" />\n</mongo:mongo-client>\n<bean id=\"defaultMongoHostCredentials\" class=\"org.springframework.data.authentication.UserCredentials\">\n<constructor-arg name=\"username\" value=\"#{systemEnvironment['MONGO_INITDB_ROOT_USERNAME']}\" />\n<constructor-arg name=\"password\" value=\"#{systemEnvironment['MONGO_INITDB_ROOT_PASSWORD']}\" />\n</bean>\n</beans>\n" > webapps/gigwa/WEB-INF/classes/applicationContext-data.xml \
